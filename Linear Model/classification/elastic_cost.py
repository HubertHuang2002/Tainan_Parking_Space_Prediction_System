...
def logistic_model_training(X_train, X_valid, X_test, y_train, y_valid, y_test):
    ...
    print(f"  Negative class (0): {N_neg} samples")
    print(f"  Positive class (1): {N_pos} samples")
    ...
    # grid search
    print("Performing grid search with cost-sensitive learning...")
    param_grid = {
        'C': [0.1, 1.0, 10.0],  
        'penalty': ['l1', 'l2'], 
        'solver': ['liblinear'], 
        'max_iter': [1000],  
        'class_weight': [class_weight, 'balanced']  # use computed class weights and balanced
    }
