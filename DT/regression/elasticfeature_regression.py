...
selected_features = [
    "TotalSpaces", "lon", "half_hour_sin", "district", "half_hour_cos", "terrestrial_radiation_instant", "lat", "day_off",
    "firstHourFee", "laterHourFee", "et0_fao_evapotranspiration", "relative_humidity_2m", "weekday_num__Saturday", "dew_point_2m",
    "weekday_num__Sunday", "surface_pressure", "pressure_msl", "wind_speed_10m"
]
...
def main():
    ...
    joblib.dump(model, "step5_elasticfeatuure_parking_tree_count.pkl")
    print("\nthe model has been saved as step5_elasticfeatuure_parking_tree_count.pkl")
