...
def main():
    ...
    joblib.dump({"model": model, "threshold": threshold}, "step3_elasticfeature_parking_tree_isfull.pkl")
    print("\nthe model and the optimal threshold have been saved as step3_elasticfeature_parking_tree_isfull.pkl")
