...
selected_features = [ 'TotalSpaces', 'lat', 'lon', 'firstHourFee', 'relative_humidity_2m',  'et0_fao_evapotranspiration',
                      'terrestrial_radiation_instant', 'day_sin', 'half_hour_sin',  'half_hour_cos', 'month_val_4',  'weekday_num__Monday', 'weekday_num__Saturday', 
                       'weekday_num__Sunday', 'day_off'
]
...
def main():
    ...
    joblib.dump(model, "step7_3votedfeature_parking_tree_count.pkl")
    print("\nthe model and the optimal threshold have been saved as step7_3votedfeature_parking_tree_count.pkl")
