...
def main():
    ...
    joblib.dump(model, "for_demo_parking_tree_isfull.pkl")
    joblib.dump({"model": model, "threshold": threshold}, "step2_parking_tree_isfull.pkl")
    print("\nthe model and the optimal threshold have been saved as  step2_parking_tree_isfull.pkl")
